 ...
 * <pre>
 * <code>
 * FcmNotification notification = new FcmNotification.Builder("myicon").build();
 * </pre></code>
 *
 * <strong>FcmNotification with optional attributes:</strong>
 * 
 * <pre>
 * <code>
 * FcmNotification notification = new FcmNotification.Builder("myicon")
 *    .title("Hello world!")
...
public final class FcmNotification implements Serializable {
    ...
    private FcmNotification(Builder builder) {
        title = builder.title;
        body = builder.body;
        icon = builder.icon;
        sound = builder.sound;
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("FcmNotification(");
        if (title != null) {
